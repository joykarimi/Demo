...
public class CustomHistoryList extends ArrayAdapter<String> {
    ...
    public CustomHistoryList(Context context, String[] name, String[] job, String[] date, String[] datedetails, String[] time, String[] timedetails, String[] rate, String[] ratedetails, Integer [] imgid) {
        super(context, R.layout.history_content,name);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // }
        CustomHistoryList.ViewHolder viewHolder=new CustomHistoryList.ViewHolder();
